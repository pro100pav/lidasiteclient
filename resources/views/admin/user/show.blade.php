                                                    ...
                                                    <div class="accordion-body-text">
                                                        <div class="profile-skills mt-3 mb-2">
                                                            ...
                                                            @foreach ($user->breadcrumbspartner($item->bot_id)->reverse() as $partner)
                                                                <a href="{{route('admin.user.managerShow', $partner->user->id)}}" class="btn btn-primary light btn-xs mb-1">@if ($partner->user->name){{$partner->user->name}}@else {{$partner->user->id}}@endif</a>
                                                            @endforeach
                                                        </div>
                                                        <div class="profile-skills mt-3 mb-2">
