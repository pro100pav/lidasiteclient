...
<div class="row page-titles">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="{{route('admin.botconstr.templateShow',$message->bot_template_id)}}">Все блоки</a></li>
    </ol>
</div>
<div class="row">
    <div class="card-body">
        <ul class="nav nav-pills mb-4 light">
            <li class=" nav-item">
                <a href="#navpills-1" class="nav-link active" data-bs-toggle="tab" aria-expanded="false">Элементы сообщения</a>
            </li>
            <li class="nav-item">
                <a href="#navpills-2" class="nav-link" data-bs-toggle="tab" aria-expanded="false">Настройки сообщения</a>
            </li>
        </ul>
                    ...
                    <div class="card card-secondary">
                        <div class="card-body">
                            <div class="row">
                                        ...
                                        @foreach ($item->buttons as $button)
                                            <div class="col-6">
                                                <div class="mb-2 position-relative" style="border: 1px solid #6e6d6d; border-radius:5px; text-align: center;">
                                                    ...
                                                    <a href="{{route('admin.botconstr.messageButtonDelete', $button->id)}}" class="delbtn" style="position: absolute;top: 0;right: 40px;font-size:1rem;"><i class="fa fa-trash"></i></a>
                                ...
                                <div class="col-12">
                                    <a href="{{route('admin.botconstr.messageItemEdit', $item->id)}}" class="btn btn-success btn-xs">Редактировать этот элмент</a>
                                    <a href="{{route('admin.botconstr.messageItemDelete', $item->id)}}" class="btn btn-danger btn-xs">Удалить этот элемент полностью</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body" style="display: block;">
                            ...
                            <div class="custom-form-floating">
                                ...
                                <select class="default-select form-control wide mb-3" name="privat">
                                    <option value="0" @if ($message->privat == '0') selected @endif>Доступно всем</option>
                                    <option value="1" @if ($message->privat == '1') selected @endif>Доступно только после подписки на группы</option>
                                </select>
                            </div>
                            <div class="row">
                                @foreach ($groups as $group)
                                    <div class="col-xl-4 col-xxl-6 col-6">
                                        <div class="form-check custom-checkbox mb-3">
                                            <input type="checkbox" class="form-check-input" name="group[]" id="group{{$loop->iteration}}" value="{{$group->id}}" @if($message->groups->contains($group))checked @endif>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body ">
                ...
                <form class="comment-form" method="POST" action="{{route('admin.botconstr.messageItemCreate', $message->id)}}">
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                <div class="form-check custom-checkbox mb-3">
                                    <input type="checkbox" class="form-check-input" name="fixed" id="fixed">
...
<div class="modal fade" id="createButton">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body ">
                <form class="comment-form" method="POST" id="butform" action="{{route('admin.botconstr.messageButtonCreate')}}">
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <p class="small">Если указываете ссылку то верхнее поле не трогаем если нужна реф кнопка указать ref</p>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="mb-3">
