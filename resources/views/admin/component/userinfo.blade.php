                    ...
                    <div class="card-body">
                        <div class="profile-statistics">
                            <div class="text-center">
                                <div class="row">
                                    <div class="col-12">
                                        @if ($user->is_username == 0)
                                            <a href="https://t.me/{{ $user->username }}" target="_blank">Открыть в телеграме</a>
                                        @endif
                                    </div>
                                    <div class="col-12">
                                        <span>Юзернейм</span>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="comment-form" method="POST" action="{{route('admin.sendmessage.userTelega', $user->id)}}">
                                                @csrf
                                                <div class="row"> 
                                                    <div class="col-lg-12">
                                                        <div class="mb-3">
